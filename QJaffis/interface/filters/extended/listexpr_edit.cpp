...
jfBaseListExprFilterEditor::jfBaseListExprFilterEditor(const jfFilterMap* infmap, const jfListExprFilterBase* infilt,
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void jfBaseListExprFilterEditor::LoadFilter(const jfBaseFilter* infilter) {
...
//------------------------------------------------------------------------------
jfBaseFilter* jfBaseListExprFilterEditor::GetFilter() {
...
bool jfBaseListExprFilterEditor::GeneralCheck() const {
  // local variables
  jfSimpleExpr* toutput;
  QString omsg;
  QMessageBox emsg;
...
// the default constructor
jfCharacterListExprFilterEditor::jfCharacterListExprFilterEditor(const jfFilterMap* infmap, const jfCharListExprFilter* infilt,
                                                               QWidget* parent):jfBaseListExprFilterEditor(infmap, infilt, parent) {

}
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
jfListExprFilterBase* jfCharacterListExprFilterEditor::MakeTypedFilter(jfListMatchMode match_mode, jfSimpleExpr* inpval) {
    return new jfCharListExprFilter(match_mode, inpval);
}
/*****************************************************************************/
